...
-- ON DELETE CASCADE 
DROP TABLE if exists adresler -- Eğer tablo varsa tabloyu siler komple
...
DELETE FROM talebeler2 WHERE id='126';--on delete cascade olmadigi icin parent icinde silme yapamayiz
delete from talebe where id 
CREATE TABLE talebe
(
...
*/
-- IN CONDITION
DROP TABLE if exists musteriler--musteriler tablosu onceden varsa sil yoksa silme
...
SELECT * FROM musteriler WHERE urun_id NOT BETWEEN 20 and 40;--20 ve 40 disindakileri verir
