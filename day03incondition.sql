...
SELECT * FROM musteriler WHERE urun_isim='Orange' OR urun_isim='Apple' OR urun_isim='Apricot';--or

--mustriler tablosundan urun_id leri '10' ve urun_ismi 'orange' olanı getir
SELECT * FROM musteriler WHERE urun_isim='Orange' AND urun_id=10;--and

--IN CONDITION
SELECT * FROM musteriler WHERE urun_isim IN ('Orange','Apple','Apricot');
--yukarida yazdigimiz or olan kismi IN komutuyla kisa sekilde yazabiliriz
...
SELECT * FROM musteriler WHERE urun_id>=20 and urun_id<=40; --NORMAL KULLANİM

SELECT * FROM musteriler WHERE urun_id BETWEEN 20 AND 40;--between kullanimi

SELECT * FROM musteriler WHERE urun_id NOT BETWEEN 20 AND 40;--20 ve 40 disindakileri getir
...
/*
Eger bir sutuna gecici olarak bişr isim vermek istersek AS komutunu yazdiktan sonra 
...
SELECT count(maas)AS maas_sayisi FROM calisanlar2;--count satirlari sayar
...
-- Her markanin ismini, calisan sayisini ve o markaya ait 
--calisanlarin maksimum ve minumum maaşinilisteleyen bir Sorgu yaziniz.
...
-- NİSAN ayında satın alan MUSTERI_ISIM'lerini listeleyen bir sorgu yazınız."NOT EXİSTS" le yap odev
...
-- Urunler tablosunda laptop satin alan musterilerin ismini, firma_ismi Apple’in irtibat_isim ile degistirin.
UPDATE urunler
