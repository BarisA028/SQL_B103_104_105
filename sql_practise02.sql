...
delete from child where urun_isim='Baris';
...
--SORU 7:child tablosunu siliniz
drop table child;
...
--child tablodaki veriyi silmeden parent tablodaki veriyi silebildik ON DELETE CASCADE ile 
--ve child tablosundaki veri de silindi***TABLO*** CHİLD SİLİNMEZ***VERİLER*** CHİLD DEKİ VERİLER SİLİNEBİLİR
delete from parent2;
